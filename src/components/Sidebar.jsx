...
const Sidebar = () => {
    ...
    return (
        <aside className="fixed top-0 left-0 h-screen w-64 bg-slate-800 text-slate-300 flex flex-col shadow-2xl z-50">
            ...
            <div className="p-4 border-t border-slate-700/50 space-y-2">
                ...
                <div className="flex items-center gap-3 px-4 py-2 pt-2">
                    <div className="w-10 h-10 bg-slate-900/50 rounded-full flex items-center justify-center text-orange-500 border border-slate-700">
                        <User size={20} />
                    </div>
