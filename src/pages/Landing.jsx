        ...
        <div className="min-h-screen bg-slate-50 font-sans selection:bg-gold-200">
            ...
            <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link to="/register" className="bg-[#ff5b00] hover:bg-[#ef4c00] text-white px-6 py-2.5 rounded-full font-bold shadow-lg shadow-gold-200 transition-all active:scale-95">
                        Crear Cuenta
                    </Link>
                </div>
            </nav>
            ...
            <main className="relative pt-20 pb-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                    <h1 className="text-5xl md:text-7xl font-black text-[#25323f] tracking-tight mb-8 leading-tight">
                        La plataforma definitiva <br/> para tu <span className="text-[#ff5b00] relative">
                            negocio
                    ...
                    <p className="text-xl text-[#305a83] mb-12 max-w-2xl mx-auto font-medium">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link to="/register" className="w-full sm:w-auto bg-[#083d5a] hover:bg-[#25323f] text-white px-8 py-4 rounded-full font-black text-lg flex items-center justify-center gap-3 transition-all hover:shadow-xl hover:shadow-[#083d5a]/20 hover:-translate-y-1">
                            Empezar Ahora <ArrowRight size={20} />
                        </Link>
                        <Link to="/login" className="w-full sm:w-auto bg-white border-2 border-gray-200 hover:border-[#ff5b00] hover:text-[#ff5b00] px-8 py-4 rounded-full font-black text-lg text-gray-600 transition-all">
                            Ya tengo un local
                        </Link>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 mt-32 grid md:grid-cols-3 gap-12">
                    <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 hover:shadow-2xl transition-shadow border border-white">
                        <div className="w-16 h-16 bg-gold-100 rounded-2xl flex items-center justify-center mb-6 text-[#ff5b00]">
                            <Store size={32} />
                        </div>
                        <h3 className="text-2xl font-black text-[#25323f] mb-4">Tienda Propia</h3>
                        <p className="text-[#305a83] font-medium leading-relaxed">Tu propio e-commerce con tu logo y tus colores. Recibí pedidos en tiempo real, sin comisiones por venta y con integración directa de Mercado Pago Checkout Pro.</p>
                    </div>
                    <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 hover:shadow-2xl transition-shadow border border-white relative">
                        <div className="absolute -top-4 -right-4 bg-[#083d5a] text-white text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-full transform rotate-12">Popular</div>
                        <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 text-[#083d5a]">
                            <ShoppingBag size={32} />
                        </div>
                        <h3 className="text-2xl font-black text-[#25323f] mb-4">Gestión Inteligente</h3>
                        <p className="text-[#305a83] font-medium leading-relaxed">Control de inventario en tiempo real, gestión de recetas, automatización de emisión de facturas y actualización rápida de precios.</p>
                    </div>
                    <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 hover:shadow-2xl transition-shadow border border-white">
                        ...
                        <p className="text-[#305a83] font-medium leading-relaxed">Toma decisiones basadas en datos. Seguimiento de ventas, productos más populares y rendimiento de tu negocio día a día.</p>
                    </div>
                </div>
